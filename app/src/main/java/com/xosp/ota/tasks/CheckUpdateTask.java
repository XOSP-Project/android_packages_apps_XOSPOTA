...
import com.xosp.ota.MainActivity;
import com.xosp.ota.R;
import com.xosp.ota.configs.AppConfig;
import com.xosp.ota.configs.LinkConfig;
import com.xosp.ota.configs.OTAConfig;
import com.xosp.ota.configs.OTAVersion;
import com.xosp.ota.dialogs.WaitDialogHandler;
import com.xosp.ota.utils.OTAUtils;
import com.xosp.ota.xml.OTADevice;
import com.xosp.ota.xml.OTAParser;
...
public class CheckUpdateTask extends AsyncTask<Context, Void, OTADevice> {
    ...
    private void showNotification(Context context) {
        ...
        builder.setSmallIcon(R.drawable.ic_launcher_xospota);
        builder.setLargeIcon(BitmapFactory.decodeResource(context.getResources(), R.drawable.ic_launcher_xospota));
